				...
				<nav id="nav">
					<ul>
                      <li><a href="editweddings.php">Weddings</a></li>
                        ...
                        <li><a href="editevents.php" >Occassions</a></li>
						<li><a href="editcorporate.php"   class="active">Corporate</a></li>
					...
					<div id="main">
						...
						<!-- One -->
							<section id="one">
								<div class="container">
									<header class="major">
										<h2 style="font-family: blooms;">Corporate Editor</h2>
									</header>
                                    ...
                                    <div class="features">
										...
										<form action="upload.php" method="post" enctype="multipart/form-data" onsubmit="return validateform();">
											<input type="hidden" name="source" id="source" value="corporate">
											<input type="hidden" name="return" id="return" value="editcorporate.php">
											<input type="hidden" name="title" 	id="title" value="Corporate" >
										...
										<?php
											$path = '../gallerydata/corporate.xml';
											...
											{ 
												...
												?>
												<div <?php echo $class; ?> >
												<form id="wedding<?php echo $i; ?>" action="processxml.php" method="post">
												<input type="hidden" id="source" 	name="source" 	value="corporate">
												<input type="hidden" id="return" 	name="return"  	value="editcorporate.php">
