				...
				<nav id="nav">
					<ul>
                      <li><a href="editweddings.php" >Weddings</a></li>
                        <li><a href="editfunerals.php"  class="active">Funerals</a></li>
					...
					<div id="main">
						...
						<!-- One -->
							<section id="one">
								<div class="container">
									<header class="major">
										<h2 style="font-family: blooms;">Funeral Editor</h2>
									</header>
                                    ...
                                    <div class="features">
										...
										<form action="upload.php" method="post" enctype="multipart/form-data" onsubmit="return validateform();">
											<input type="hidden" name="source" id="source" value="funerals">
											<input type="hidden" name="return" id="return" value="editfunerals.php">
											<input type="hidden" name="title" 	id="title" value="Funerals" >
										...
										<?php
											...
											{ 
												...
												?>
												<div <?php echo $class; ?> >
												<form id="funeral<?php echo $i; ?>" action="processxml.php" method="post">
												<input type="hidden" id="source" 	name="source" 	value="funerals">
												<input type="hidden" id="return" 	name="return"  	value="editfunerals.php">
