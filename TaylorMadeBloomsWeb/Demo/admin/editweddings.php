	...
	<body>
		...
		<!-- Header -->
            <section id="header">   
				...
				<nav id="nav">
					<ul>
                      <li><a href="editweddings.php"  class="active">Weddings</a></li>
					...
					<div id="main">
						...
						<!-- One -->
							<section id="one">
								<div class="container">
									<header class="major">
										<h2 style="font-family: blooms;">Weddings Editor</h2>
									</header>
                                    ...
                                    <div class="features">
										...
										<form action="upload.php" method="post" enctype="multipart/form-data" onsubmit="return validateform();">
											<input type="hidden" name="source" id="source" value="wedding">
											<input type="hidden" name="return" id="return" value="editweddings.php">
											<input type="hidden" name="title" 	id="title" value="Wedding" >
										...
										<?php
											...
											{ 
												...
												<input type="hidden" id="source" 	name="source" 	value="weddings">
												<input type="hidden" id="return" 	name="return"  	value="editweddings.php">
